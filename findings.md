...
The supported claim is limited to: under a shared post-training XGrammar-constrained AgentAction evaluation, one v2.3 seed shows directional intent-layer gains and preserves deterministic system-level safety blocking.
...
Detailed evidence is in `results/agent-eval-v23-seed-20260827/experiment-summary.json` and `qualification.json`.
